...
#    """
    ...
    def __init__(self, pData, cSystem, numBatches, batchSize, shuffle=True, useGPU=True):
        ...
        x,y,t = SchrodingerEquationDataset.get3DGrid(640,480,500)
        Exact_u = Exact_u.reshape(640,480,3000)
        
        self.u =[]
        for xi in range(640):
          for yi in range(480):
            for ti in range(500):
              self.u.append(Exact_u[xi,yi,ti])
        
        x,y,t = SchrodingerEquationDataset.pixelToCoordinate(x, y, t, cSystem)
