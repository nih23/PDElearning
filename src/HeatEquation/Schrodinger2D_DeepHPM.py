...
from Schrodinger2DDatasets import HeatEquationHPMDataset
from Schrodinger2D_baseline_nohvd import  writeIntermediateState, valLoss, save_checkpoint, load_checkpoint, writeValidationLoss, SchrodingerNet
...
class HeatEquationHPMNet(SchrodingerNet):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pData", dest="pData", type=str, default="/home/h7/szch154b/2014_022_rest.mat")
    ...
    # create dataset
    ds = HeatEquationHPMDataset(args.pData, coordinateSystem, args.numBatches, args.batchsize, shuffle=True, useGPU=True)
    ...
    #load_checkpoint(model, './results/models/with_params_3/0_ic/model_37000.pt')
